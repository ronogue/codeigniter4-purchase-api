...
return [
    ...
    'alpha_numeric_punct'   => 'O campo {field} deve conter apenas caracteres alfanuméricos, espaços e os caracteres ~ ! # $ % & * - _ + = | : .',
    'alpha_numeric_space'   => 'O campo {field} deve conter apenas caracteres alfanuméricos e espaços.',
    'alpha_space'           => 'O campo {field} deve conter apenas caracteres alfabéticos e espaços.',
    ...
    'in_list'               => 'O campo {field} deve ser um dos: {param}.',
    ...
    'not_in_list'           => 'O campo {field} não deve ser um dos: {param}.',
    ...
    'valid_emails'          => 'O campo {field} deve conter apenas endereços de e-mail válidos.',
    ...
    'is_image' => '{field} não é uma imagem válida ou não foi enviada corretamente.',
